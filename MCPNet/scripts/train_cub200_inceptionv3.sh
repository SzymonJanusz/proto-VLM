#!/bin/bash
#SBATCH --job-name=mcpnet_cub_inc
...
#SBATCH --output=/net/tscratch/people/plgabedychaj/logs/mcpnet_cub_inc_%j.out
#SBATCH --error=/net/tscratch/people/plgabedychaj/logs/mcpnet_cub_inc_%j.err
