"""Top-level SaG model (ported from kdwonn/SaG model/cross_modal_attention.py)."""
import torch
...
from .encoders import ImageTextEncoders, l2norm, ImageTextEncodersRecon
from .decoder import MlpDecoder, TransformerDecoder
...
class CrossModalAttentionRecon(nn.Module):
    """Main SaG model: Shatter-and-Gather with reconstruction objective."""
