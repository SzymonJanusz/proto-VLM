"""Vision Transformer backbone (ported from kdwonn/SaG, originally from segmenter)."""
import torch
import torch.nn as nn

from .transformers.utils import init_weights, resize_pos_embed
from .transformers.blocks import Block
