...
# ---------------------------------------------------------------------------
# Path setup: proto-non-param lives as a sibling directory
# ---------------------------------------------------------------------------
SCRIPT_DIR = os.path.dirname(os.path.abspath(__file__))
REPO_ROOT = os.path.dirname(SCRIPT_DIR)
PNP_DIR = os.path.join(REPO_ROOT, "proto-non-param")
...
from sag_refseg.data.refer_dataset import ReferDataset                # noqa: E402
...
def build_model(ckpt_path: str, device: torch.device):
    ...
    if not os.path.isabs(vocab_cache_path):
        vocab_cache_path = os.path.join(PNP_DIR, vocab_cache_path)
