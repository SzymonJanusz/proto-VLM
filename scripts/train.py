...
from PIPNet.models.hybrid_model import ProtoCLIP
from PIPNet.training.trainer import ProtoCLIPTrainer
from PIPNet.training.losses import CombinedLoss
from PIPNet.data.imagenet_dataset import create_imagenet_loaders
from PIPNet.data.caption_generator import (
    ImageNetCaptionGenerator,
    download_imagenet_class_mapping
)
from PIPNet.utils.early_stopping import EarlyStopping
...
def stage2_projection(model, train_loader, args):
    ...
    from PIPNet.utils.projection import PrototypeProjector
    from PIPNet.utils.visualization import visualize_prototypes, save_prototype_grid
    from PIPNet.data.transforms import get_val_transforms
    from PIPNet.data.imagenet_dataset import create_imagenet_loaders
